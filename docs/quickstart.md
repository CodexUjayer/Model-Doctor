...
# Iterate through high-risk findings
...
Next, dive deeper into the [Diagnose API](diagnose.md) or learn how the [Architecture](architecture.md) works under the hood.
